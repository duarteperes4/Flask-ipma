...
def handle_error(message):
    """
    Função para lidar com erros , mostra uma mensagem com Flash e redireciona para a rota principal (index) 
    """
...
def resultado ():
    ...
    try:
        ...
        return handle_error ("Não foi possível contactar a API do IPMA")
